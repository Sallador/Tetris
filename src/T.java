...
public class T extends Block {
    ...
    public T(Field field) {
        super(field);
        //forming an T-plank in the upper invisible part of the game field
    ...
    protected SortedSet<Point> rotateRightResult() {
        ...
        if (pointArray[0].getY() == pointArray[2].getY()) {
            ...
            */
        ...
        } else if (pointArray[0].getX() == pointArray[3].getX() && pointArray[2].getX() > pointArray[1].getX()) {
            /*
                x
                x x     ->     x x x
                x                x
             */
            int correction = (pointArray[1].getX() - 1 >= 0) ? 0 : 1;
            ...
            newPoints.add(new Point(pointArray[1].getX() + 1 + correction, pointArray[1].getY()));
            newPoints.add(new Point(pointArray[1].getX() + correction, pointArray[1].getY() - 1));
            ...
            */
            ...
            newPoints.add(new Point(pointArray[2].getX() - 1 + correction, pointArray[2].getY()));
            newPoints.add(new Point(pointArray[2].getX() + correction, pointArray[2].getY() + 1));
        }
        return newPoints;
    }
